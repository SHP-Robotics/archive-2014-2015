...
import edu.wpi.first.wpilibj.templates.commands.DoNothing;
 ...
 *
 * <p>
 * This is the main robot class for an robot that is designed to deliver sodas.
 ...
 *
 * <p>
 * In is recommended that you have read at least the beginning of the cookbook
 * and are familiar with the basics of command base programming before you start
 * trying to understand this example. When reading through this, the recommended
 * order is:</p>
 * <ol>
 * <li>{@link RobotMap}</li>
 ...
 *
 * <p>
 * The only modifications from the default file created are setting the
 * autonomousCommand to SodaDelivery in robotInit and a few calls to status
 * functions in teleopPeriodic.</p>
 *
 * <p>
 * Recommended next step: {@link RobotMap}</p>
 *
 * @author Alex Henning
 */
